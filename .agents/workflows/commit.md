...
**⚠️ LANGUE : Tous les messages de commit (titre ET description) doivent être rédigés en français.**
...
```bash
git add -A; git commit -m "<TITRE DU COMMIT EN FRANÇAIS>" -m "<DESCRIPTION DETAILLEE EN FRANÇAIS>"; git push
```
