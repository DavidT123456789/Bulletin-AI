 ...
 * Modèles officiels vérifiés et compatibles APIs directes & passerelles.
...
export const COSTS_PER_MILLION_TOKENS = {
    ...
    'anthropic-claude-3-opus-latest': { input: 15.00, output: 75.00 },
...
export const MODEL_DESCRIPTIONS = {
    ...
    // Google
    'gemini-2.5-flash': "<strong>⭐ Recommandé.</strong> Le standard Google, ultra-rapide, intelligent et économique.",
    'gemini-2.5-pro': "<strong>🔥 Puissant.</strong> Excellent pour les synthèses complexes et détaillées.",
    'gemini-2.0-flash': "<strong>Stable.</strong> Flash éprouvé, très rapide.",
    // OpenRouter - Gratuits
    ...
    'claude-3.7-sonnet': "<strong>✨ Recommandé.</strong> Claude 3.7 Sonnet (via OpenRouter). Raisonnement hybride et style.",
    'claude-3.5-sonnet': "Claude 3.5 Sonnet (via OpenRouter). Finesse rédactionnelle.",
    // Ollama
    ...
    // Anthropic (Claude) - API directe
    'anthropic-claude-3-7-sonnet-latest': "<strong>✨ Recommandé.</strong> Claude 3.7 Sonnet. Finesse stylistique et raisonnement.",
    ...
    'anthropic-claude-3-opus-latest': "<strong>🔥 Le plus puissant.</strong> Claude 3 Opus. Qualité maximale.",
    // Mistral - API directe (Plan Experiment GRATUIT : 1B tokens/mois !)
...
export const FALLBACK_CONFIG = {
    ...
    openrouter: ['llama-3.3-70b-free', 'claude-3.7-sonnet', 'claude-3.5-sonnet', 'ministral-3b', 'openrouter', 'deepseek-r1', 'amazon-nova-v1-lite', 'mistral-small', 'mistral-large'],
    ollama: ['ollama-qwen2.5:7b', 'ollama-mistral:7b', 'ollama-deepseek-r1:8b', 'ollama-gemma2:9b'],
    anthropic: ['anthropic-claude-3-7-sonnet-latest', 'anthropic-claude-3-5-sonnet-latest', 'anthropic-claude-3-5-haiku-latest', 'anthropic-claude-3-opus-latest'],
...
export const PROVIDER_DEFAULT_MODELS = {
    google: FALLBACK_CONFIG.google[0],       // gemini-2.5-flash (stable, recommandé)
    ...
    anthropic: FALLBACK_CONFIG.anthropic[0], // anthropic-claude-3-7-sonnet-latest
...
export const MODEL_SELECTOR_CONFIG = [
    ...
    },
    {
        ...
        models: [
            { id: 'gemini-2.5-flash', qualifier: 'Recommandé' },
            { id: 'gemini-2.5-pro', qualifier: 'Puissant' },
            { id: 'gemini-2.0-flash', qualifier: 'Stable' },
        ]
    },
    {
    ...
    },
    {
        ...
        models: [
            { id: 'claude-3.7-sonnet', qualifier: 'Style & Raisonnement' },
            { id: 'claude-3.5-sonnet', qualifier: 'Précis' },
    ...
    },
    {
        ...
        models: [
            { id: 'anthropic-claude-3-7-sonnet-latest', qualifier: 'Recommandé' },
            { id: 'anthropic-claude-3-5-sonnet-latest', qualifier: 'Stable' },
            { id: 'anthropic-claude-3-5-haiku-latest', qualifier: 'Économique & Rapide' },
            { id: 'anthropic-claude-3-opus-latest', qualifier: 'Le plus puissant' },
        ]
    },
    {
        label: '🏠 Ollama — LOCAL',
